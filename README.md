...
AIM: To study and implement C++ decision-making statements and Loops
...
2. Use a for loop to print “COLLEGE” 5 times
- This program demonstrates the use of a for loop for fixed repetition.
- The loop runs exactly 5 times, printing the string “COLLEGE” during each iteration.
...
- This is useful when you want to ignore specific values or cases while continuing the loop.
- It helps in controlling the flow inside loops more precisely without breaking them completely.

4-8. Using for loops, print the following patterns
...
- Each row prints several asterisks equal to the row number.
...
(02) PRINT COLLEGE 5 TIMES
1. Start the program.
2. Use a loop variable i starting from 0 up to 4.
3. For each value of i, do the following:
4. Print the value of i+1 followed by a dot and the word "COLLEGE" on a new line.
